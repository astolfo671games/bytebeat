...
4. Render your bytebeat into a WAV using the "Render WAV" button on D3nschot's website:
https://d3nschot.github.io/ThisBeat2.1

5. Put the rendered audio into the ./bytebeat directory

6. Put your bytebeat code into in.txt
